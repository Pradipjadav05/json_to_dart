...
class _JsonToDartState extends State<JsonToDart> {
  // Controllers for JSON and class name input fields.
  final TextEditingController _jsonController = TextEditingController();
  final TextEditingController _classNameController =
      TextEditingController(text: "MyGeneratedClass");

  // Variable to store the generated Dart code.
  String _dartCode = '';

  // Checkboxes to control code generation options.
  bool isNullable = false; // For making fields nullable.
  bool isLate = false; // For marking fields as late.
  bool isRequired = true; // For requiring fields in the constructor.

  // Function to convert JSON to Dart class.
  ...
  // Function to generate Dart code from JSON data.
  String _generateDartCode(String className, dynamic json) {
    ...
    if (json is Map) {
      ...
      // Generate fields based on JSON properties.
  ...
  // Function to get the type name for List elements.
